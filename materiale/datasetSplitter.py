...
file_path = os.path.join(base_path,'../Mirage-AppxAct.parquet')
print(file_path)
...
train_output_path = os.path.join(base_path,'./trainSet.parquet')
test_output_path = os.path.join(base_path,'./testSet.parquet')
